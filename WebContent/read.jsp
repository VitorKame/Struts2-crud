...
<html>
	...
	<body>
		...
		<div class="page">
			<div>
				<label class="titulo">Exames</label><br>
			</div>
					...
					<tbody>
						<c:forEach var="lista" items="${listaExames}">
							<tr>
								...
								<td class="acoes">
									<a class="botao2" href="update?id_ex=<c:out value='${lista.id_ex}'/>">Editar</a>
									<a class="botao2" href="delete?id_ex=<c:out value='${lista.id_ex}'/>">Deletar</a>
								</td>
							</tr>
						</c:forEach>	
					</tbody>
